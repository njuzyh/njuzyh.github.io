...
/* date last modified: 2025-10-11 08:36:46 */
...
function main() {
            addJs('https://clustrmaps.com/bl/scripts/counter.js', "2246786");
...
function embed_clustrmaps(script_el, embed_after_script){
    ...
    if($('#clustrmaps-widget-v2').length === 0){
        ...
        */
                            var link = '<a target="_top" href="http://clustrmaps.com/site/1c5mq" title="ClustrMaps People Search" id="clustrmaps-widget-v2">';
